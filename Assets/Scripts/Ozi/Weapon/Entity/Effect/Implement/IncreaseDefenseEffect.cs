namespace Ozi.Weapon.Entity.Effect.Implement {
    public class IncreaseDefenseEffect : BasicEffect {
        public const int MAX_STACK = 3;
        public const float DEFENSE_LEVEL = 5;

        public override string Title => "저항의 선율";
        public override string Description => "신비로운 선율에 의해 방어력이 증가했습니다.";
        ...
        public IncreaseDefenseEffect(EffectParam param) : base(param) { }
