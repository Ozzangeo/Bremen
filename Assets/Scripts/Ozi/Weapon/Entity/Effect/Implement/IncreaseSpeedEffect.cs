namespace Ozi.Weapon.Entity.Effect.Implement {
    public class IncreaseSpeedEffect : BasicEffect {
        public const int MAX_STACK = 3;
        public const float SPEED_LEVEL = 2;

        public override string Title => "신속의 선율";
        public override string Description => "신비로운 선율에 의해 이동속도가 증가했습니다.";
        ...
        public IncreaseSpeedEffect(EffectParam param) : base(param) {}
